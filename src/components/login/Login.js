...
const Login = ({setIsAuthenticated}) => {
    ...
    const {loginList} = useContext(TrendzContext)
    ...
    const handleSubmit = e => {
        ...
        if (users && users.password === password) {
            ...
            setErrors('Username or password didn\'t match')
        }
        console.log(users)
    }
  ...
  return (
    <div className='login-main-container'>
                ...
                <div className="left-0 right-0 inline-block border-gray-200 px-2 py-2.5 sm:px-4">
                        ...
                        <div>
                            <div className="mb-2">
                                <label className="text-sm font-medium text-gray-900 dark:text-gray-300"
                                    htmlFor="email">Username or Email:</label>
                            </div>
                    ...
                    {errors && <p className="text-red-500 text-sm mt-2 text-center">{errors}</p>}
                        <div className="mt-4 text-center dark:text-gray-200">New user?
                            <button className="text-blue-500 underline hover:text-blue-600" onClick={clickToCreate}>Create account
                                here</button>
                        </div>
                        </div>
                        </div>
        ...
        <div>
            <img src="./asset/flat-char.png" alt='login' className='login-img'/>
        </div>
    </div>
  )
}
